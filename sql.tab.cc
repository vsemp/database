...
#line 37 "sql.tab.cc" // lalr1.cc:399
...
namespace yy {
#line 115 "sql.tab.cc" // lalr1.cc:403
...
#line 581 "sql.tab.cc" // lalr1.cc:403
...
#line 589 "sql.tab.cc" // lalr1.cc:407
...
namespace yy {
#line 656 "sql.tab.cc" // lalr1.cc:474
      ...
      try
        {
          switch (yyn)
            {
  case 4:
#line 42 "sql.y" // lalr1.cc:847
    { return 0; }
#line 1050 "sql.tab.cc" // lalr1.cc:847
    break;

  case 5:
#line 46 "sql.y" // lalr1.cc:847
    { evalexpr(optimize(compile(makeexpr(OP_INSERTROW, 2, (yystack_[5].value), (yystack_[2].value))))); (yylhs.value)=0; }
#line 1056 "sql.tab.cc" // lalr1.cc:847
    break;

  case 6:
#line 49 "sql.y" // lalr1.cc:847
    { printf("Multi-row insert not implemented yet\n"); }
#line 1062 "sql.tab.cc" // lalr1.cc:847
    break;

  case 7:
#line 52 "sql.y" // lalr1.cc:847
    { print_relation(evalexpr(optimize(compile((yystack_[1].value))))); }
#line 1068 "sql.tab.cc" // lalr1.cc:847
    break;

  case 8:
#line 55 "sql.y" // lalr1.cc:847
    { printf("UPDATE not implemented yet\n"); }
#line 1074 "sql.tab.cc" // lalr1.cc:847
    break;

  case 9:
#line 58 "sql.y" // lalr1.cc:847
    { printf("DELETE not implemented yet\n"); }
#line 1080 "sql.tab.cc" // lalr1.cc:847
    break;

  case 10:
#line 61 "sql.y" // lalr1.cc:847
    { evalexpr(optimize(compile(makeexpr(OP_CREATETABLE, 2, (yystack_[4].value), (yystack_[2].value))))); (yylhs.value)=0; }
#line 1086 "sql.tab.cc" // lalr1.cc:847
    break;

  case 11:
#line 64 "sql.y" // lalr1.cc:847
    { printf("DESCRIBE not implemented yet\n"); }
#line 1092 "sql.tab.cc" // lalr1.cc:847
    break;

  case 12:
#line 68 "sql.y" // lalr1.cc:847
    { printf("SHOW TABLES not implemented yet\n"); }
#line 1098 "sql.tab.cc" // lalr1.cc:847
    break;

  case 13:
#line 72 "sql.y" // lalr1.cc:847
    { printf("DROP TABLE not implemented yet\n"); }
#line 1104 "sql.tab.cc" // lalr1.cc:847
    break;

  case 15:
#line 79 "sql.y" // lalr1.cc:847
    {
		  (yylhs.value) = makeexpr(OP_TABLENAME, 1, (yystack_[0].value), 0);
		}
#line 1112 "sql.tab.cc" // lalr1.cc:847
    break;

  case 16:
#line 85 "sql.y" // lalr1.cc:847
    {
		  (yylhs.value) = makeexpr(OP_COLNAME, 1, (yystack_[0].value), 0);
		}
#line 1120 "sql.tab.cc" // lalr1.cc:847
    break;

  case 18:
#line 92 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr((yystack_[1].value), 2, (yystack_[2].value), (yystack_[0].value)); }
#line 1126 "sql.tab.cc" // lalr1.cc:847
    break;

  case 19:
#line 94 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr((yystack_[3].value), 2, (yystack_[4].value), (yystack_[1].value)); }
#line 1132 "sql.tab.cc" // lalr1.cc:847
    break;

  case 20:
#line 96 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr((yystack_[3].value), 2, (yystack_[4].value), (yystack_[1].value)); }
#line 1138 "sql.tab.cc" // lalr1.cc:847
    break;

  case 21:
#line 98 "sql.y" // lalr1.cc:847
    { (yylhs.value) = (yystack_[1].value); }
#line 1144 "sql.tab.cc" // lalr1.cc:847
    break;

  case 22:
#line 100 "sql.y" // lalr1.cc:847
    { (yylhs.value) = (yystack_[1].value); }
#line 1150 "sql.tab.cc" // lalr1.cc:847
    break;

  case 23:
#line 102 "sql.y" // lalr1.cc:847
    { (yylhs.value) = (yystack_[0].value); }
#line 1156 "sql.tab.cc" // lalr1.cc:847
    break;

  case 24:
#line 106 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_FCALL, 2, makeexpr(OP_FNAME, 1, (yystack_[3].value), 0), (yystack_[1].value)); }
#line 1162 "sql.tab.cc" // lalr1.cc:847
    break;

  case 25:
#line 108 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_FCALL, 2, makeexpr(OP_FNAME, 1, (yystack_[2].value), 0), 0); }
#line 1168 "sql.tab.cc" // lalr1.cc:847
    break;

  case 26:
#line 112 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, (yystack_[0].value), 0); }
#line 1174 "sql.tab.cc" // lalr1.cc:847
    break;

  case 27:
#line 114 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, (yystack_[0].value), (yystack_[2].value)); }
#line 1180 "sql.tab.cc" // lalr1.cc:847
    break;

  case 28:
#line 119 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_COLNAME, 1, (yystack_[0].value), 0); }
#line 1186 "sql.tab.cc" // lalr1.cc:847
    break;

  case 29:
#line 121 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_NUMBER, 1, (yystack_[0].value), 0); }
#line 1192 "sql.tab.cc" // lalr1.cc:847
    break;

  case 30:
#line 123 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_STRING, 1, (yystack_[0].value), 0); }
#line 1198 "sql.tab.cc" // lalr1.cc:847
    break;

  case 31:
#line 127 "sql.y" // lalr1.cc:847
...
#line 1210 "sql.tab.cc" // lalr1.cc:847
    break;

  case 32:
#line 136 "sql.y" // lalr1.cc:847
    { (yylhs.value) = 0; }
#line 1216 "sql.tab.cc" // lalr1.cc:847
    break;

  case 33:
#line 137 "sql.y" // lalr1.cc:847
    { (yylhs.value) = (yystack_[0].value); }
#line 1222 "sql.tab.cc" // lalr1.cc:847
    break;

  case 34:
#line 140 "sql.y" // lalr1.cc:847
    { (yylhs.value) = 0; }
#line 1228 "sql.tab.cc" // lalr1.cc:847
    break;

  case 35:
#line 141 "sql.y" // lalr1.cc:847
    { (yylhs.value) = (yystack_[0].value); }
#line 1234 "sql.tab.cc" // lalr1.cc:847
    break;

  case 36:
#line 144 "sql.y" // lalr1.cc:847
    { (yylhs.value) = 0; }
#line 1240 "sql.tab.cc" // lalr1.cc:847
    break;

  case 37:
#line 146 "sql.y" // lalr1.cc:847
    { (yylhs.value) = (yystack_[0].value); }
#line 1246 "sql.tab.cc" // lalr1.cc:847
    break;

  case 38:
#line 150 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, (yystack_[0].value), 0); }
#line 1252 "sql.tab.cc" // lalr1.cc:847
    break;

  case 39:
#line 152 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, (yystack_[0].value), (yystack_[2].value)); }
#line 1258 "sql.tab.cc" // lalr1.cc:847
    break;

  case 41:
#line 158 "sql.y" // lalr1.cc:847
    { (yylhs.value) = 0; }
#line 1264 "sql.tab.cc" // lalr1.cc:847
    break;

  case 42:
#line 160 "sql.y" // lalr1.cc:847
    { (yylhs.value) = (yystack_[0].value); }
#line 1270 "sql.tab.cc" // lalr1.cc:847
    break;

  case 43:
#line 164 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, (yystack_[0].value), 0); }
#line 1276 "sql.tab.cc" // lalr1.cc:847
    break;

  case 44:
#line 166 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, (yystack_[0].value), (yystack_[2].value)); }
#line 1282 "sql.tab.cc" // lalr1.cc:847
    break;

  case 45:
#line 170 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_SORTSPEC, 2, makeexpr(OP_NUMBER, 1, (yystack_[0].value), 0), 0); }
#line 1288 "sql.tab.cc" // lalr1.cc:847
    break;

  case 46:
#line 172 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_SORTSPEC, 2, makeexpr(OP_NUMBER, 1, (yystack_[1].value), 0), 0); }
#line 1294 "sql.tab.cc" // lalr1.cc:847
    break;

  case 47:
#line 174 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_SORTSPEC, 2, makeexpr(OP_NUMBER, 1, (yystack_[1].value), 0), makeexpr(OP_NULL, 0, 0, 0)); }
#line 1300 "sql.tab.cc" // lalr1.cc:847
    break;

  case 48:
#line 176 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_SORTSPEC, 2, makeexpr(OP_COLNAME, 1, (yystack_[0].value), 0), 0); }
#line 1306 "sql.tab.cc" // lalr1.cc:847
    break;

  case 49:
#line 178 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_SORTSPEC, 2, makeexpr(OP_COLNAME, 1, (yystack_[1].value), 0), 0); }
#line 1312 "sql.tab.cc" // lalr1.cc:847
    break;

  case 50:
#line 180 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_SORTSPEC, 2, makeexpr(OP_COLNAME, 1, (yystack_[1].value), 0), makeexpr(OP_NULL, 0, 0, 0)); }
#line 1318 "sql.tab.cc" // lalr1.cc:847
    break;

  case 51:
#line 184 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, (yystack_[0].value), 0); }
#line 1324 "sql.tab.cc" // lalr1.cc:847
    break;

  case 52:
#line 186 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, (yystack_[0].value), (yystack_[2].value)); }
#line 1330 "sql.tab.cc" // lalr1.cc:847
    break;

  case 53:
#line 190 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_OUTCOLNAME, 2, (yystack_[2].value), (yystack_[0].value)); }
#line 1336 "sql.tab.cc" // lalr1.cc:847
    break;

  case 54:
#line 192 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_OUTCOLNAME, 2, (yystack_[0].value), (yystack_[0].value)); }
#line 1342 "sql.tab.cc" // lalr1.cc:847
    break;

  case 55:
#line 196 "sql.y" // lalr1.cc:847
    { (yylhs.value) = (yystack_[0].value); }
#line 1348 "sql.tab.cc" // lalr1.cc:847
    break;

  case 56:
#line 198 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_PRODUCT, 2, (yystack_[2].value), (yystack_[0].value)); }
#line 1354 "sql.tab.cc" // lalr1.cc:847
    break;

  case 57:
#line 202 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, makeexpr(OP_NUMBER, 1, (yystack_[0].value), 0), 0); }
#line 1360 "sql.tab.cc" // lalr1.cc:847
    break;

  case 58:
#line 204 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, makeexpr(OP_STRING, 1, (yystack_[0].value), 0), 0); }
#line 1366 "sql.tab.cc" // lalr1.cc:847
    break;

  case 59:
#line 206 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, makeexpr(OP_NULL,0,0, 0), 0); }
#line 1372 "sql.tab.cc" // lalr1.cc:847
    break;

  case 60:
#line 208 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, makeexpr(OP_NUMBER, 1, (yystack_[0].value), 0), (yystack_[2].value)); }
#line 1378 "sql.tab.cc" // lalr1.cc:847
    break;

  case 61:
#line 210 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, makeexpr(OP_STRING, 1, (yystack_[0].value), 0), (yystack_[2].value)); }
#line 1384 "sql.tab.cc" // lalr1.cc:847
    break;

  case 62:
#line 212 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, makeexpr(OP_NULL, 0, 0, 0), (yystack_[2].value)); }
#line 1390 "sql.tab.cc" // lalr1.cc:847
    break;

  case 63:
#line 216 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, (yystack_[0].value), 0); }
#line 1396 "sql.tab.cc" // lalr1.cc:847
    break;

  case 64:
#line 218 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_RLIST, 2, (yystack_[0].value), (yystack_[2].value)); }
#line 1402 "sql.tab.cc" // lalr1.cc:847
    break;

  case 65:
#line 222 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_COLUMNDEF, 2, (yystack_[0].value), 0); }
#line 1408 "sql.tab.cc" // lalr1.cc:847
    break;

  case 66:
#line 224 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_COLUMNDEF, 2, (yystack_[1].value), makeexpr(OP_STRING, 1, (int)"KEY", 0)); }
#line 1414 "sql.tab.cc" // lalr1.cc:847
    break;

  case 67:
#line 226 "sql.y" // lalr1.cc:847
    { (yylhs.value) = makeexpr(OP_COLUMNDEF, 2, (yystack_[2].value), makeexpr(OP_STRING, 1, (int)"PRIMARY", 0)); }
#line 1420 "sql.tab.cc" // lalr1.cc:847
    break;

  case 68:
#line 229 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_EQUAL; }
#line 1426 "sql.tab.cc" // lalr1.cc:847
    break;

  case 69:
#line 230 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_NOTEQ; }
#line 1432 "sql.tab.cc" // lalr1.cc:847
    break;

  case 70:
#line 231 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_GT; }
#line 1438 "sql.tab.cc" // lalr1.cc:847
    break;

  case 71:
#line 232 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_LT; }
#line 1444 "sql.tab.cc" // lalr1.cc:847
    break;

  case 72:
#line 233 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_GEQ; }
#line 1450 "sql.tab.cc" // lalr1.cc:847
    break;

  case 73:
#line 234 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_LEQ; }
#line 1456 "sql.tab.cc" // lalr1.cc:847
    break;

  case 74:
#line 235 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_PLUS; }
#line 1462 "sql.tab.cc" // lalr1.cc:847
    break;

  case 75:
#line 236 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_BMINUS; }
#line 1468 "sql.tab.cc" // lalr1.cc:847
    break;

  case 76:
#line 237 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_TIMES; }
#line 1474 "sql.tab.cc" // lalr1.cc:847
    break;

  case 77:
#line 238 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_DIVIDE; }
#line 1480 "sql.tab.cc" // lalr1.cc:847
    break;

  case 78:
#line 239 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_AND; }
#line 1486 "sql.tab.cc" // lalr1.cc:847
    break;

  case 79:
#line 240 "sql.y" // lalr1.cc:847
    { (yylhs.value) = OP_OR; }
#line 1492 "sql.tab.cc" // lalr1.cc:847
    break;


#line 1496 "sql.tab.cc" // lalr1.cc:847
            default:
              break;
            }
        }
...
#line 1936 "sql.tab.cc" // lalr1.cc:1155
#line 243 "sql.y" // lalr1.cc:1156
